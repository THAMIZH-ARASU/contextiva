...
10. **Remaining Task**: Need to register auth router in `src/api/main.py` once main app structure is reviewed.
...
- 95%+ of tasks completed (pending only auth router registration in main.py)
